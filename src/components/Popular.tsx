...
async function currentlyshowing() {
  let response = await fetch('https://api.themoviedb.org/3/movie/popular?language=en-US&page=1&api_key=a7254d75a3e4ef2c23e8d349f8f4cede');
...
async function Popular({ vertical }: any) {
      ...
      <div className="mx-5 lg:mx-10 py-1 lg:py-2 flex items-center justify-between border-b border-b-gray-500 relative mb-4">
        {vertical ? null : <>
          <div className="flex items-center space-x-4">
            ...
            <h2 className="text-sm uppercase font-bold tracking-wider">Popular</h2>
          </div>

          <Link href={{ pathname: "/viewmore", query: { title: "popular" } }}
